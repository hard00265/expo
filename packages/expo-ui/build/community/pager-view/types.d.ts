...
export type PagerViewRef = {
    /**
     * Animate the pager to the given page index.
     *
     * @remarks On iOS the animation uses SwiftUI's default `withAnimation`
     * curve (~0.35 s easeInOut), which is slightly looser than upstream
     * `react-native-pager-view`'s ~0.25 s. The page index is silently no-op'd
